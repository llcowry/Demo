//lxlResizable
(function($) {
  $.fn.lxlResizable = function() {
    return $.lxlui.run.call(this, "lxlResizable", arguments, {
      idAttrName: 'lxluiresizableid',
      hasElement: false,
      propertyToElemnt: 'target'
    });
  };
  $.fn.lxlResizableMgr = function() {
    return $.lxlui.run.call(this, "lxlResizableMgr", arguments, {
      idAttrName: 'lxluiresizableid',
      hasElement: false,
      propertyToElemnt: 'target'
    });
  };
  $.lxlDefaults.Resizable = {
  ...
  $.lxlui.controls.Resizable = function(options) {
    $.lxlui.controls.Resizable.base.constructor.call(this, null, options);
  };
  $.lxlui.controls.Resizable.lxlExtend($.lxlui.core.UIComponent, {
    __getType: function() {
      return 'Resizable';
    },
    __idPrev: function() {
    ...
    _render: function() {
      ...
      g.target = $(p.target);
      g.set(p);
      g.target.bind('mousedown.resizable', function(e) {
        ...
        if (p.target.lxluidragid) {
          var drag = $.lxlui.get(p.target.lxluidragid);
          if (drag && g.dir) {
    ...
    _rendered: function() {
      this.options.target.lxluiresizableid = this.id;
    },
    _getDir: function(e) {
      var g = this,
        p = this.options;
    ...
    _createProxy: function() {
      var g = this;
      g.proxy = $('<div class="resizable"></div>');
