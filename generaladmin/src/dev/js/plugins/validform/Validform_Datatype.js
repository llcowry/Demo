...
(function() {
  if ($.Datatype) {
    $.extend($.Tipmsg.w, {
      ...
      "ipv6": "请填写IPv6地址！",
      "num": "请填写数值！",
      "nn": "请填写大于0的整数", //新增 2016年5月31日17:49:54
      "dec": "请填写非负的整数或小数", //新增 2016年5月31日17:49:54
      "d": "请填写整数或小数", //新增 2016年5月31日17:49:54
      "dd": "请填写大于0的整数或小数", //新增 2016年5月31日17:49:54
      "qq": "请填写QQ号码！",
      "unequal": "值不能相等！",
      "notvalued": "不能含有特定值！",
      "idcard": "身份证号码不对！"
    ...
    $.extend($.Datatype, {
      ...
      //非负的整数或小数;
      "dec": /^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,4})?$/,

      //整数或小数;
      "d": /^-?(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,4})?$/,

      //大于0的整数或小数;
      // "dd": /^([1-9]\d*(\.\d*[1-9])?)|(0\.\d*[1-9])$/,
      "dd": /^([1-9]\d*(\.\d*[0-9])?)|(0\.\d*[1-9]0*)$/,
